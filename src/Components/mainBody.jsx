  ...
  return (
    ...
    <path d="M8.75 12.25H12.25"  stroke-linecap="round"/>
                ...
                <section className='space-y-[1.5625rem] w-full  pl-[2.75rem] relative'> 
                    ...
                    <div className='flex items-center   '>
                        <div  className={`${readPath === 'recruitment' || readPath === 'jobposting' || readPath === 'candidates' || readPath === 'interviews' ? 'flex' : 'hidden'} absolute  left-0  navBarhover `}></div>
                        <div className='navLinkconfig'>
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={readPath === 'recruitment' || readPath === 'jobposting' || readPath === 'candidates' || readPath === 'interviews'? 'white' : '#5D6150'} stroke-width="1.5">
                            ...
                            <div>
                                <NavLink to='/jobposting'><h4 className={`${readPath === 'recruitment' || readPath === 'jobposting' || readPath === 'candidates' || readPath === 'interviews'? 'text-white' : 'text-limegray'}`}>Recruitment</h4></NavLink>
                            </div>
                        </div>
                    </div>
                    {/* Performance */}
...
<path d="M10.5 14C12.433 14 14 12.433 14 10.5C14 8.567 12.433 7 10.5 7"  stroke-linecap="round"/>
                    ...
                    {/* Training */}
                    <div className='flex items-center   '>
                        <div  className={`${readPath === 'overviewTraining' || readPath === 'program' || readPath === 'enrolment' || readPath === 'feedBackTraning' ? 'flex' : 'hidden'} absolute  left-0  navBarhover `}></div>
                        <div className='navLinkconfig'>
                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" stroke={readPath === 'overviewTraining' || readPath === 'program' || readPath === 'enrolment' || readPath === 'feedBackTraning' ? 'white' : '#5D6150'} stroke-width="1.5">
                            ...
                            <div>
                                <NavLink to='/overviewTraining'><h4 className={`${readPath === 'overviewTraining' || readPath === 'program' || readPath === 'enrolment' || readPath === 'feedBackTraning' ? 'text-white' : 'text-limegray'}`}>Training</h4></NavLink>
                            </div>
                        </div>
                    </div>
                </section>
