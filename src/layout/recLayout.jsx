...
const RecLayout = ({ readPath }) => {
  ...
  const location = useLocation()
    ...
    { label: "360 Feedback ", path: "/feedBack" }
      ...
      const NavTraning = [
    { label: "Overview", path: "/overviewTraining" },
    { label: "Programs", path: "/program" },
    { label: "Enrolment ", path: "/enrolment" },
    { label: "Feedback", path: "/feedBackTraning" }
  ]
  ...
  return (
    <div className='w-[calc(100%-2.75rem)]'>
        ...
        <div className={`${readPath === 'performance' || readPath === 'feedBack' || readPath === 'goals' || readPath === 'overview' || readPath === 'reviews' ? 'block' : 'hidden'} cursor-pointer flex flex-col gap-[3.3125rem]`}>
            ...
            <div className="center-center gap-[1.75rem] font-semibold">
                ...
                <div
                    ...
                    className={`w-[8.875rem]  text-center flex justify-center  py-[0.875rem] relative px-[1.875rem]  text-nowrap  ${location.pathname === item1.path ? 'text-lemongreen' : 'textLimegray1'}`}>
                    {item1.label}
        ...
        <div className={`${readPath === 'training' || readPath === 'program' || readPath === 'enrolment' || readPath === 'overviewTraining' || readPath === 'feedBackTraning' ? 'block' : 'hidden'} cursor-pointer flex flex-col gap-[3.3125rem]`}>
            {/* InformationContainers */}
            <div className='flex gap-[1.25rem]  font-semibold'>
            <div className='carDash2'>
                <div className='h-full between flex-col'>
            ...
            <div className="center-center gap-[0.875rem]     font-semibold">
                ...
                <div
                    ...
                    className={`w-[8.875rem]  flex justify-center py-[0.875rem] relative px-[1.875rem]  text-nowrap  ${location.pathname === item2.path ? 'text-lemongreen' : 'textLimegray1'}`}>
                    {item2.label}
                    <div className={`${location.pathname === item2.path ? 'absolute left-0 h-[3px] w-full bottom-0 rounded-[0.375rem] bg-lemongreen' : ''}`}></div>
                </div>
                ))}
